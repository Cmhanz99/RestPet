...
<body>
    <div class="chat-container">
        ...
        <div class="contacts-sidebar">
            ...
            <a href="/dashboard" style="padding: 10px 20px; display: inline-block; text-decoration: none; color: #4a6fa5;">
            ...
            <ul class="contact-list">
                ...
                <li class="contact-item active">
                    <div class="contact-avatar" style="background-image: url('{{asset('user-profile/' . $user->image)}}')"></div>
                    <div class="contact-details">
                        <div class="contact-name">{{$user->name}}</div>
                        <div class="contact-preview">{{$recent->message}}</div>
                    </div>
        ...
        <div class="chat-main">
            <div class="chat-top-bar">
                <div class="chat-top-avatar" style="background-image: url('{{asset('user-profile/' . $user->image)}}')"></div>
            ...
            <form class="chat-input-container" action="/reply/{{$user->id}}#bottomDiv" method="POST">
                ...
                <input type="text" autocomplete="off" class="chat-input" name="reply" placeholder="Type your message...">
