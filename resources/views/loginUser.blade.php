...
<body class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="w-full relative max-w-md p-8 bg-white rounded shadow-[1px_1px_2px_rgba(0,0,0,0.5)]">
        <h2 class="text-2xl font-bold text-center mb-6">Welcome User</h2>
        ...
        <form action="/loggedIn" method="post">
            ...
            <div class="mt-4 text-center text-sm">
                ...
                <a href="/registrationUser" class="text-blue-600 hover:underline">register here</a>
            </div>
            <div class="mt-4 text-center text-sm">
                <a href="/login" class="text-white px-10 py-2 bg-black rounded">Owner Login</a>
            </div>
        </form>
    </div>
</body>
