                        ...
                        <div class="form-section">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" name="title" value="{{$lot->title}}" placeholder="Enter garden name" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row two-columns">
                                <div class="form-group">
                                    ...
                                    <select id="type" name="type" required>
                                        <option value="Individual"{{$lot->type == 'Individual' ? 'selected' : ''}}>Individual</option>
                                        <option value="Communal"{{$lot->type == 'Communal' ? 'selected' : ''}}>Communal</option>
                                        <option value="Private"{{$lot->type == 'Private' ? 'selected' : ''}}>Private</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="area" name="area" required>
                                        <option value="west-location"  {{$lot->type == 'west-location' ? 'selected' : ''}}>West Location</option>
                                        <option value="east-location"  {{$lot->type == 'east-location' ? 'selected' : ''}}>East Location</option>
                                        <option value="north-location" {{$lot->type == 'north-location' ? 'selected' : ''}}>North Location</option>
                                        <option value="south-location" {{$lot->type == 'south-location' ? 'selected' : ''}}>South Location</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-row two-columns">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="size" name="size" value="{{$lot->size}}" placeholder="Enter size in sq ft" required>
                                </div>

                                <div class="form-group">
                                    <label for="slots">Number of Slots *</label>
                                    <input type="number" id="slots" name="slots" value="{{$lot->slots}}" min="1" placeholder="Enter number of slots" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="price" name="price" value="{{$lot->price}}" placeholder="Enter price" required>
                                </div>
                            </div>
                            <div class="form-row two-columns">
                                <div class="form-row">
                                    <div class="form-group">
                                        <select type="text" id="marker" name="marker">
                                            <option value="Includes-Marker" {{$lot->marker == 'Includes-Marker' ? 'selected' : ''}}>Inlcudes Marker</option>
                                            <option value="No-Marker" {{$lot->marker == 'No-Marker' ? 'selected' : ''}}>No-Marker</option>
                                        </select>
                                    </div>
                                </div>
